    ...
    if (stagingtype == STAGINGTYPESERIAL) {
        for (int n = 1; n < 8; n++) {
            if (totalmass[n] != 0) {
                ...
                segment1.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
            }
        }
    }
        ...
        for (int n = 1; n < 8; n++) {
           if(totalmass[n] != 0) {
                ...
                heightpos = (mrocket.height/(n+1)) + (mrocket.height*portionfactor);
                {
                    ...
                    nozzle.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
                    ...
                    booster1.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
                    boosterpayload1.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
                    //Then, for the wireframe effect increase the radius
                    booster1.radius *= 1.03;
                    boosterpayload1.radius *= 1.03;
                    //Render again
                    boosterpayload1.renderfigure(200, 200, 200, GL_LINES);
                    booster1.renderfigure(200, 200, 200, GL_LINES);
                    ...
                    nozzle2.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
                    //Set vertex amount
                    booster2.vertexnum = 32;
                    boosterpayload2.vertexnum = 32;
                    //First, render the solid booster
                    booster2.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
                    boosterpayload2.renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
                    //Then, for the wireframe effect increase the radius
                    booster2.radius *= 1.03;
                    boosterpayload2.radius *= 1.03;
                    //Render again
                    boosterpayload2.renderfigure(200, 200, 200, GL_LINES);
                    booster2.renderfigure(200, 200, 200, GL_LINES);
                }
...
void aerodynamics::renderFins(bool hasBoosters, fullrocket mrocket) {
    ...
    twinfins[0].renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
    twinfins[1].renderfigure(100, 100, 100, GL_TRIANGLE_STRIP);
}
...
void rocket::renderRocketCylinder(GLenum primtype) {
    ...
    passMeasurements();
    rcylinder.renderfigure(190, 190, 190, primtype);
    radius *= 1.03;
    rcylinder.vertexnum = 32;
    rcylinder.renderfigure(200, 200, 200, GL_LINES);
...
void tip::renderRocketTip(GLenum primtype, rocket body) {
    ...
    tipbody.renderfigure(150, 150, 150, GL_TRIANGLE_STRIP);
    tipbody.radius *= 1.01;
    tipbody.renderfigure(200, 200, 200, GL_LINES);
    tipsphere1.renderfigure(150, 150, 150, GL_POLYGON);
    tipsphere2.renderfigure(150, 150, 150, GL_POLYGON);
    tipsphere1.stacks = 32;
    tipsphere1.sectors = 32;
    tipsphere2.stacks = 32;
    tipsphere2.sectors = 32;
    tipsphere1.renderfigure(200, 200, 200, GL_LINE_STRIP);
    tipsphere2.renderfigure(200, 200, 200, GL_LINE_STRIP);
}