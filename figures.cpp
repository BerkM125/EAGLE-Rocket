...
void cylinder::renderfigure(GLubyte R, GLubyte G, GLubyte B, GLenum primtype) {
    GLfloat x = xcoord;
    GLfloat y = ycoord;
    GLfloat z = zcoord;
    GLfloat angle = 0.0;
...
void cone::renderfigure(GLubyte R, GLubyte G, GLubyte B, GLenum primtype) {
    GLfloat x = xcoord;
    GLfloat y = ycoord;
    GLfloat z = zcoord;
    GLfloat angle = 0.0;
...
void cube::renderfigure(GLubyte R, GLubyte G, GLubyte B, GLenum primtype) {
    GLfloat x = xcoord;
    GLfloat y = ycoord;
    GLfloat z = zcoord;
    GLfloat colortint = 0;
...
void sphere::renderfigure(GLubyte R, GLubyte G, GLubyte B, GLenum primtype) {
    GLfloat x = 0.0;
    GLfloat y = 0.0;
    GLfloat z = 0.0;
    GLfloat xy = 0.0;
...
void triprism::renderfigure(GLubyte R, GLubyte G, GLubyte B, GLenum primtype) {
